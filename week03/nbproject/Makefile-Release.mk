...
${OBJECTDIR}/average1.o: average1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/average1.o average1.cpp

${OBJECTDIR}/averageNDW.o: averageNDW.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/averageNDW.o averageNDW.cpp
...
${OBJECTDIR}/while_choice.o: while_choice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/while_choice.o while_choice.cpp

${OBJECTDIR}/while_choice_1.o: while_choice_1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/while_choice_1.o while_choice_1.cpp
